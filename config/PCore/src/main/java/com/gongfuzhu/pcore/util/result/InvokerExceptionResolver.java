package com.gongfuzhu.pcore.util.result;

import com.gongfuzhu.pcore.util.result.content.ResultException;
import com.gongfuzhu.pcore.util.result.event.ExceptionApplicationEvent;
